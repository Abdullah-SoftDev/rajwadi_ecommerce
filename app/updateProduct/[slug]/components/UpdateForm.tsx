...
const UpdateForm = ({ product }: { product: TProduct }) => {
    ...
    const { productName, productDescription, productImages, price, category, sizes, stockAvailable } = data;
    ...
    const updateForm = async () => {
        if (product.productName === productName && product.productDescription === productDescription && product.productImages === productImages && product.price === price && product.category === category && product.sizes === sizes && product.stockAvailable === stockAvailable) {
